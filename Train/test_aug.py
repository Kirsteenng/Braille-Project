...
if __name__ == '__main__':
    ...
    dataset = Braille_Dataset(path_data=path, resize=True, mode='test', transformer=aug_param)
    ...
    # checkpoint_path = f"./only_depth/braille_model_depth.ckpt"
